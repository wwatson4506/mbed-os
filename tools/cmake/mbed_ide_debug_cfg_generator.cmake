...
"// Auto-generated by Mbed CE.  Edits will be erased when CMake is rerun.
{
	...
	function(mbed_generate_ide_debug_configuration CMAKE_TARGET)
		...
		list(JOIN UPLOAD_LAUNCH_COMMANDS "\", \"" UPLOAD_LAUNCH_COMMANDS_FOR_JSON)
		list(JOIN UPLOAD_RESTART_COMMANDS "\", \"" UPLOAD_RESTART_COMMANDS_FOR_JSON)
	...
	function(mbed_finalize_ide_debug_configurations)
		...
		# Generate tasks.json, which contains a task to start the GDB server
		...
		# Convert the CMake list into a string format suitable for a json list.
		# Note: This currently doesn't handle gdbserver arguments containing spaces,
		# additional logic might be needed later for that.
		string(JOIN " " DEBUG_COMMAND_STR ${UPLOAD_GDBSERVER_DEBUG_COMMAND})
		string(REPLACE "\"" "\\\"" DEBUG_COMMAND_STR "${DEBUG_COMMAND_STR}")

		file(GENERATE OUTPUT ${VSCODE_TASKS_JSON_PATH} CONTENT
"// Auto-generated by Mbed CE.  Edits will be erased when CMake is rerun.
{
	\"version\": \"2.0.0\",
	\"tasks\": [
...
${UPLOAD_LAUNCH_COMMANDS_FOR_GDBINIT}"
		...
		add_custom_target(gdbserver
			...
			COMMAND ${UPLOAD_GDBSERVER_DEBUG_COMMAND}
			USES_TERMINAL
			VERBATIM)
	endfunction(mbed_finalize_ide_debug_configurations)
